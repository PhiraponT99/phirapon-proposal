...
import { Mail, ArrowUp, Atom } from 'lucide-react';
...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="border-t border-slate-900 bg-navy-950/60 py-12 px-6 md:px-12 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex items-center gap-6">
          ...
          <button
            onClick={scrollToTop}
            className="p-2 rounded bg-navy-800 hover:bg-navy-700 text-slate-400 hover:text-white transition-colors border border-slate-800/40"
